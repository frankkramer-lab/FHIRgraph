 ...
 */
@ResourceDef(name = "GraphResource", profile = "http://hl7.org/fhir/profiles/graph-resource")
public class GraphResource extends DomainResource {
    ...
    @Override
    public GraphResource copy() {
        GraphResource retVal = new GraphResource();
